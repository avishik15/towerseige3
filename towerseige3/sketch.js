...
function draw() {
  ...
  textSize(20);
  fill("black");
  text("drag polygon to destroy the blocks",350,50);
  text("press space to reset polygon",350,80);
  text("press reload to reset game entirely",700,500);
